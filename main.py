...
def Action(): #Выполнение действий, основываясь на направлении
    if sum_ == 2 or sum_ == 3 or sum_ == 0: #Комната находится слева?
        PD_line_l_x(2, 1.2, 400, 300, 35, 20, 125, 110, 40, -50) #ПРИМЕРНОЕ ЗНАЧЕНИЕ
        ...
        PD_line_r_x(2, 1.2, 400, 300, 35, 20, 125, 110, 40, -50) #ПРИМЕРНОЕ ЗНАЧЕНИЕ
